...
/**
 * [CommonPreview] can be applied to either of the following:
 ...
 * annotation classes, which will then be considered as indirectly annotated with that [CommonPreview].
 */
@MustBeDocumented
